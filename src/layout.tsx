...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-PEHGCMJSN9"></script><script>window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments)}gtag('js',new Date());gtag('config','G-PEHGCMJSN9',{anonymize_ip:true});</script>
